...
<head>
    ...
    <style>
        ...
        * {
        ...
        #chat-widget-header {
            background: linear-gradient(135deg, #3b88bf 0%, #3b88bf 100%);
            color: white;
            padding: 16px 20px;
            display: flex;
        ...
        #chat-widget-button {
            ...
            bottom: 20px;
            right: 20px;
            background: linear-gradient(135deg, #3b88bf 0%, #2d6a92 100%);
            color: white;
            border: none;
            width: 60px;
            height: 60px;
    ...
    <div id="chat-widget-container">
        <div id="chat-widget-header">
            <div class="chat-header-content">
                <img src="https://www.undefipourlavie.com/wp-content/uploads/2022/04/logo-udplv.png" alt="Logo" class="chat-logo">
                <div class="chat-brand-info">
                    <div class="chat-brand-name">UN DÉFI POUR LA VIE</div>
        ...
        <div id="chat-widget-footer">
            ...
            <div class="input-container">
                ...
                <button id="chat-widget-send">Envoyer</button>
            </div>
